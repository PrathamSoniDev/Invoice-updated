...
export const mockModuleConfigs: ModuleConfig[] = [
  { key: 'dashboard', label: 'Dashboard', description: 'Analytics overview and metrics', enabled: true, icon: 'LayoutDashboard', roles: ['admin', 'manager', 'staff', 'viewer'] },
  { key: 'customers', label: 'Customers', description: 'Manage customer profiles and data', enabled: true, icon: 'Users', roles: ['admin', 'manager', 'staff'] },
  { key: 'invoices', label: 'Invoices', description: 'Create and manage invoices', enabled: true, icon: 'FileText', roles: ['admin', 'manager', 'staff'] },
  { key: 'payment-links', label: 'Payment Links', description: 'Generate and track payment links', enabled: true, icon: 'CreditCard', roles: ['admin', 'manager', 'staff'] },
  { key: 'whatsapp', label: 'WhatsApp', description: 'WhatsApp communication center', enabled: true, icon: 'MessageCircle', roles: ['admin', 'manager', 'staff'] },
  { key: 'email', label: 'Email', description: 'Email communication center', enabled: true, icon: 'Mail', roles: ['admin', 'manager', 'staff'] },
  { key: 'reports', label: 'Reports', description: 'Business reports and analytics', enabled: true, icon: 'BarChart3', roles: ['admin', 'manager', 'viewer'] },
  { key: 'settings', label: 'Settings', description: 'Company and system settings', enabled: true, icon: 'Settings', roles: ['admin', 'manager'] },
  { key: 'admin', label: 'Admin', description: 'User and module administration', enabled: true, icon: 'ShieldCheck', roles: ['admin'] },
];
